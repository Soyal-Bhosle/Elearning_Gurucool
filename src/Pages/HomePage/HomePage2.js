        ...
        <div className={classes.container}>
          {user ? (
            <>
              ...
              <Button className={classes.button} variant="contained" color="primary" href="/homepage/courses">
                View Courses
        ...
        <div className={classes.outcomesContainer}>
          ...
          <div className={classes.outcomeImageContainer}>
            {LEARNER_OUTCOMES.map((outcome, index) => (
              <img key={index} src={outcome.image} alt={outcome.alt} className={classes.outcomeImage} />
            ))}
          </div>
        </div>
      </div>
