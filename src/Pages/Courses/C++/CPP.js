...
function CPP() {
  ...
  const handleUnlockCertificate = () => {
    window.location.href = '/Homepage/courses/CPP/pop';
  }
   ...
   <div >
    ...
    <Container maxWidth="md">
      ...
      <Typography variant="body1" gutterBottom>
        C++ is a popular programming language used for developing a wide range of applications including operating systems, video games, and high-performance applications. This course will cover topics such as data types, control structures, functions, classes, and more.
      </Typography>
      <ReactPlayer 
        url="https://youtu.be/oi1ffu6lBXE" 
        playing 
        controls 
